...
class TestAuthenticationBundle:
    ...
    def test_region_validation_empty_string(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            AuthenticationBundle(
                cookies=[], region="", extraction_timestamp=datetime.now()
            )
    ...
    def test_region_validation_whitespace_trimmed(self):
        ...
        bundle = AuthenticationBundle(
            cookies=[], region="  us-east  ", extraction_timestamp=datetime.now()
        )
    ...
    def test_is_expired_not_expired(self):
        ...
        bundle = AuthenticationBundle(
            cookies=[], region="us-east", extraction_timestamp=recent_time
        )
    ...
    def test_is_expired_expired(self):
        ...
        bundle = AuthenticationBundle(
            cookies=[], region="us-east", extraction_timestamp=old_time
        )
...
class TestTokenExtractionResult:
    ...
    def test_extraction_method_validation_valid_methods(self):
        ...
        for method in valid_methods:
            result = TokenExtractionResult(
                success=True, extraction_method=method, extraction_duration=1.0
            )
    ...
    def test_extraction_duration_validation_negative(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            TokenExtractionResult(
                success=True, extraction_method="javascript", extraction_duration=-1.0
            )

        assert "extraction_duration must be a non-negative number" in str(
            exc_info.value
        )
    ...
    def test_extraction_duration_validation_zero(self):
        ...
        result = TokenExtractionResult(
            success=True, extraction_method="javascript", extraction_duration=0.0
        )
    ...
    def test_extraction_duration_validation_converts_int(self):
        ...
        result = TokenExtractionResult(
            success=True, extraction_method="javascript", extraction_duration=5
        )
