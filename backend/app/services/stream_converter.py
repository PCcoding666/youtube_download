...
class StreamConverter:
    ...
    async def convert_m3u8_to_mp4(
        ...
        try:
            ...
            logger.info(f"Conversion completed in {duration:.2f}s, file size: {file_size / 1024 / 1024:.2f}MB")
    ...
    def _build_ffmpeg_command(self, input_url: str, output_file: str) -> list:
        ...
        cmd = [
            ...
            '-timeout', '30000000',  # 30 second timeout for connections
    ...
    async def convert_and_merge(
        ...
        try:
            ...
            duration = time.time() - start_time
            file_size = os.path.getsize(output_file)
            logger.info(f"Merge completed in {duration:.2f}s, file size: {file_size / 1024 / 1024:.2f}MB")
