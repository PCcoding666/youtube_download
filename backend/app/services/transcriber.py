...
class ParaformerTranscriber:
    ...
    async def transcribe_from_url(
        self, audio_url: str, enable_diarization: bool = True, language: str = "auto"
    ...
    async def _submit_task(self, audio_url: str, enable_diarization: bool) -> Any:
        """Submit async transcription task."""
...
async def transcribe_audio(
    audio_url: str, api_key: Optional[str] = None, enable_diarization: bool = True
) -> Optional[List[Dict[str, Any]]]:
    """
    ...
    return await transcriber.transcribe_from_url(
        audio_url, enable_diarization=enable_diarization
    )
