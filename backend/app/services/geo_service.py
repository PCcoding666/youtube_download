...
COUNTRY_TO_REGION: Dict[str, str] = {
    ...
    'DE': 'de', 'AT': 'de', 'CH': 'de', 'PL': 'de', 'CZ': 'de', 'HU': 'de',
    ...
    # Southeast Asia
    'SG': 'sg', 'MY': 'sg', 'TH': 'sg', 'VN': 'sg', 'PH': 'sg', 'ID': 'sg',
    
    # India and South Asia
    'IN': 'in', 'BD': 'in', 'PK': 'in', 'LK': 'in', 'NP': 'in',
    
    # Australia and Oceania
    'AU': 'au', 'NZ': 'au', 'FJ': 'au',
    
    # China and Hong Kong/Taiwan - route to Singapore or Japan
    'CN': 'sg', 'HK': 'sg', 'TW': 'jp', 'MO': 'sg',
    ...
    # Southern Europe
    'IT': 'fr', 'ES': 'fr', 'PT': 'fr', 'GR': 'de',
    
    # Middle East - route to Singapore or UK
    'AE': 'sg', 'SA': 'sg', 'IL': 'uk', 'TR': 'de',
    
    # Africa - route to UK or France
    'ZA': 'uk', 'EG': 'uk', 'NG': 'uk', 'KE': 'uk',
    'MA': 'fr', 'DZ': 'fr', 'TN': 'fr',
    
    # South America - route to US
    'BR': 'us', 'AR': 'us', 'CL': 'us', 'CO': 'us', 'PE': 'us', 'VE': 'us',
}
...
class GeoIPService:
    ...
    def _init_geoip_database(self):
        ...
        if not db_path.exists():
            logger.warning(f"GeoIP database not found at {self.geoip_db_path}, using online API")
            return
